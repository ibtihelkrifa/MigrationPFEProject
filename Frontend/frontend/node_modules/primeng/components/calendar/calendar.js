...
var Calendar = /** @class */ (function () {
    ...
    Calendar.prototype.isOutsideClicked = function (event) {
        var triggerClicked = this.el.nativeElement.isSameNode(event.target) || this.el.nativeElement.contains(event.target);
        if (this.appendTo) {
            return !triggerClicked && !(this.overlay && this.overlay.contains(event.target));
        }
        else {

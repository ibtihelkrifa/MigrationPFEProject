...
class Test4 {
  ...
  def function():String=
  {
    ...
    aggregation(incrementaggrega,idrow,tablesource,colonnessources, targettable,numberOfAggrigations,keyjoin);





    def aggregation(incrementaggrega: Int,idrow : String, tablesource: String,colonnessources: String,targettable: String,numberparentaggregations: Int, keyjoin: String): Unit =
    {
      ...
      if(incrementaggrega < numberparentaggregations-1)
      {
  ...
  ///// recursiv and paralle with map reduce
